...
import in.sahilpatel.bulletinboard.authentication.FacebookAuth;
...
//                            openHomeActivity();
    ...
    private void signInWithFacebook() {
        ...
        mFacebookAuth = new FacebookAuth(this,loginButton,callbackManager);

        mFacebookAuth.signIn(new OnAuthenticationListener() {
            @Override
            public void onAuthenticationSuccess(String message, int status_code, final User user) {
                progressDialog.setMessage("Signing in....");
                progressDialog.show();
